...
def _register_cognitive_tools(mcp: FastMCP, handler: CognitiveToolHandler) -> None:
    ...
    async def programming_paradigms(
        problem: str,
        complexity_level: str = "moderate",
        current_paradigms: Optional[list[str]] = None,
        target_paradigms: Optional[list[str]] = None,
    ...
    async def debugging_approaches(
        ...
        complexity_level: str = "moderate",
        problem_domain: Optional[str] = None,
        error_symptoms: Optional[list[str]] = None,
        system_complexity: Optional[str] = None,
    ...
    async def metacognitive_monitoring(
        problem: str,
        complexity_level: str = "moderate",
        reasoning_target: Optional[str] = None,
    ...
    async def collaborative_reasoning(
        problem: str,
        complexity_level: str = "moderate",
        collaboration_objective: Optional[str] = None,
        perspectives_needed: Optional[list[str]] = None,
        max_rounds: int = 3,
    ...
    async def iterative_validation(
        ...
        previous_cycles: Optional[list[dict]] = None
    ) -> Dict[str, Any]:
        """
    ...
    async def multi_perspective_analysis(
        ...
        predefined_perspectives: Optional[list[dict]] = None,
        focus_areas: Optional[list[str]] = None,
    ...
    async def sequential_readiness_assessment(
        ...
        complexity_level: str = "moderate",
        domain_context: Optional[str] = None,
        predefined_states: Optional[list[dict]] = None,
    ...
    async def triple_constraint_optimization(
        ...
        predefined_constraints: Optional[list[dict]] = None,
        optimization_focus: Optional[str] = None,
        flexibility_parameters: Optional[dict[str, float]] = None,
        risk_tolerance: str = "medium",
        timeline_flexibility: str = "medium",
