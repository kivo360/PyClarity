...
from pyclarity.tools.mental_models import (
    MentalModelsAnalyzer, MentalModelContext, MentalModelType, ComplexityLevel
)
from pyclarity.tools.sequential_thinking import (
    SequentialThinkingAnalyzer, SequentialThinkingContext, BranchStrategy
)
from pyclarity.tools.decision_framework import (
    DecisionFrameworkAnalyzer, DecisionFrameworkContext, DecisionCriteria, DecisionOption, CriteriaType
)
from pyclarity.tools.scientific_method import (
    ScientificMethodAnalyzer, ScientificMethodContext
)
from pyclarity.tools.design_patterns import (
    DesignPatternsAnalyzer, DesignPatternsContext
)
from pyclarity.tools.programming_paradigms import (
    ProgrammingParadigmsAnalyzer, ProgrammingParadigmsContext
)
from pyclarity.tools.debugging_approaches import (
    DebuggingApproachesAnalyzer, DebuggingApproachesContext
)
from pyclarity.tools.visual_reasoning import (
    VisualReasoningAnalyzer, VisualReasoningContext, VisualElement, VisualRepresentationType
)
from pyclarity.tools.structured_argumentation import (
    StructuredArgumentationAnalyzer, StructuredArgumentationContext
)
from pyclarity.tools.metacognitive_monitoring import (
    MetacognitiveMonitoringAnalyzer, MetacognitiveMonitoringContext
)
from pyclarity.tools.collaborative_reasoning import (
    CollaborativeReasoningAnalyzer, CollaborativeReasoningContext
)
# Temporarily comment out impact_propagation due to generic type issues
# from pyclarity.tools.impact_propagation import (
#     ImpactPropagationAnalyzer, ImpactPropagationContext
# )

# New FastMCP tools
from pyclarity.tools.iterative_validation import (
    IterativeValidationAnalyzer, IterativeValidationContext
)
from pyclarity.tools.multi_perspective import (
    MultiPerspectiveAnalyzer, MultiPerspectiveContext
)
from pyclarity.tools.sequential_readiness import (
    SequentialReadinessAnalyzer, SequentialReadinessContext
)
from pyclarity.tools.triple_constraint import (
    TripleConstraintAnalyzer, TripleConstraintContext
)
...
class CognitiveToolHandler:
    ...
    async def handle_decision_framework(
        ...
        decision_methods: Optional[List[str]] = None,
    ...
    async def handle_impact_propagation(self, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"tool": "Impact Propagation", "error": str(e), "success": False}    async def handle_iterative_validation(self, **kwargs) -> Dict[str, Any]:
