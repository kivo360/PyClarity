...
class ImpactPropagationAnalyzer(BaseCognitiveAnalyzer[ImpactPropagationContext, ImpactPropagationResult]):
    ...
    async def _extract_entities(self, scenario: str, domain: Optional[str]) -> List[Dict[str, Any]]:
    ...
    async def _identify_cascade_effects(
        self, network: Dict[str, Any], paths: List[PropagationPath], time_horizon: Optional[str]
    ) -> List[ImpactEvent]:
