# Clear Thinking FastMCP Server - Sequential Readiness Framework Models

"""
Pydantic models for Sequential Readiness Framework cognitive tool.

This model enables analysis of processes that require progressive readiness 
through ordered states, applicable to change management, skill development,
system maturity, or any domain with sequential dependencies.
"""
